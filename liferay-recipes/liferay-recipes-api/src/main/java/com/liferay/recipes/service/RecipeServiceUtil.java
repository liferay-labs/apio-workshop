...
public class RecipeServiceUtil {
     ...
     */
    public static com.liferay.recipes.model.Recipe addRecipe(String name,
        ...
        return getService()
            .addRecipe(name, region, imageFileEntryId, publishedDate,
                hoursToMake, minutesToMake, steps, ingredients, videoURL,
                serviceContext);
    }
