...
@Component(
    immediate = true,
    property = {
        "liferay.recipes.max.assistants=1", "liferay.recipes.max.recipes=1",
        "liferay.recipes.max.restaurants=1",
        "liferay.recipes.max.restaurants.per.assistant=1"
    },
...
public class RecipesDemo extends BasePortalInstanceLifecycleListener {
    ...
    public void portalInstanceRegistered(Company company) throws Exception {
        ...
        _log.info("Password for every created user is: `apio`");
    }
