...
public class RecipeResource {
	...
	public Recipe retrieve(long id) throws PortalException {
		return _recipeService.getRecipe(id);
	}

	public List<Recipe> retrieve(Group group) {
		return _recipeService.getRecipesByGroupId(group.getGroupId(), -1, -1);
	}
