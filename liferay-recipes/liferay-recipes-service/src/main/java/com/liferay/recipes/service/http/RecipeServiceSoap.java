...
public class RecipeServiceSoap {
     ...
     */
    public static com.liferay.recipes.model.RecipeSoap deleteRecipe(
        long recipeId) throws RemoteException {
        try {
            com.liferay.recipes.model.Recipe returnValue = RecipeServiceUtil.deleteRecipe(recipeId);
     ...
     */
    public static com.liferay.recipes.model.RecipeSoap addRecipe(String name,
        ...
        throws RemoteException {
        try {
            com.liferay.recipes.model.Recipe returnValue = RecipeServiceUtil.addRecipe(name,
