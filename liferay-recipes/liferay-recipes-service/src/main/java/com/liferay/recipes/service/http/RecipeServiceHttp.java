...
public class RecipeServiceHttp {
    ...
    public static com.liferay.recipes.model.Recipe deleteRecipe(
        ...
        try {
            MethodKey methodKey = new MethodKey(RecipeServiceUtil.class,
                "deleteRecipe", _deleteRecipeParameterTypes2);
    ...
    public static com.liferay.recipes.model.Recipe addRecipe(
        HttpPrincipal httpPrincipal, String name, String region,
        Long imageFileEntryId, java.util.Date publishedDate, int hoursToMake,
        int minutesToMake, java.util.List<String> steps,
        java.util.List<String> ingredients, String videoURL,
        com.liferay.portal.kernel.service.ServiceContext serviceContext)
        throws com.liferay.portal.kernel.exception.PortalException {
        try {
            MethodKey methodKey = new MethodKey(RecipeServiceUtil.class,
                "addRecipe", _addRecipeParameterTypes3);

            MethodHandler methodHandler = new MethodHandler(methodKey, name,
                region, imageFileEntryId, publishedDate, hoursToMake,
    ...
    public static int getRecipesCountByGroupId(HttpPrincipal httpPrincipal,
        ...
        try {
            MethodKey methodKey = new MethodKey(RecipeServiceUtil.class,
                ...
                _getRecipesCountByGroupIdParameterTypes4);
    ...
    private static final Class<?>[] _deleteRecipeParameterTypes2 = new Class[]{
        long.class
    };
    private static final Class<?>[] _addRecipeParameterTypes3 = new Class[]{
    ...
    private static final Class<?>[] _getRecipesCountByGroupIdParameterTypes4 = new Class[]{
        long.class
    };
